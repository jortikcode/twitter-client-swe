        ...
        <>
            <div className="w-100 flex justify-center items-center p-5 dark:bg-gray-900">
                <div className="md:w-3/4 w-11/12">
                    <h1 className="text-6xl md:text-7xl text-center tracking-wide text-sky-500 pb-32" style={borderText}>Twitta come i pro! </h1>
                    <div className="w-100 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <article className="flex order-1 justify-center items-center">
                            <p className="text-2xl dark:text-white">Usa anche tu questo client di twitter, sta spopolando!</p>
                        </article>
                        ...
                        <article className="md:order-4 order-3 flex justify-center items-center">
                            <p className="text-2xl dark:text-white">Puoi effettuare ricerche di tweet e filtrarli come vuoi tu!</p>
                        </article>
                        <article className="order-5 flex justify-center items-center">
                            <p className="text-2xl dark:text-white">Una volta effettuata la ricerca puoi visualizzare i risultati in tantissimi modi diversi!</p>
                        </article>
